...
DEBUG = False
#EVOK_API = "http://192.168.2.4:8080"
EVOK_API = "http://127.0.0.1:8080"
EVOK_API_RETRIES = 5
MQTT_BROKER = "192.168.20.3"
...
class Controller():
    ...
    def mqtt_on_connect(self, client, userdata, flags, rc):
        ...
        client.subscribe("solarControl/solar/temp")
        client.subscribe("solarControl/solar/temp_in")
        client.subscribe("solarControl/solar/temp_out")
        # Use heater temperatures published by external system
        client.subscribe("solarControl/heater/temp_in")
        client.subscribe("solarControl/heater/temp_out")
    ...
    def mqtt_on_message(self, client, userdata, msg):
        ...
        elif topic == "solarControl/solar/temp_in":
            self.set_temp("solar_in", float(msg.payload))
        elif topic == "solarControl/solar/temp_out":
            self.set_temp("solar_out", float(msg.payload))
        elif topic == "solarControl/heater/temp_in":
    ...
    def run_circulation(self):
        return # FIXME Disable circulation
    ...
    def run_heater(self):
        # T5 = self.temperatures['heater_out']
        # T4 = self.temperatures['heater_in']
